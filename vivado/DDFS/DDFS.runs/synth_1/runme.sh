...
HD_PWD='C:/Users/fu/Dropbox/UNI/MASTER/1M/PSM/DIGITALE/2018_vhdl/2-DDFS/vivado/DDFS/DDFS.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DDFS_WRAPPER.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DDFS_WRAPPER.tcl
