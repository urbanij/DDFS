...
HD_PWD='C:/Users/fu/Dropbox/UNI/MASTER/1M/PSM/DIGITALE/2018_vhdl/2-DDFS/vivado/DDFS/DDFS.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DDFS_WRAPPER.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DDFS_WRAPPER.tcl -notrace
